...
Bu ürün/hizmet hangi platformda?

A) 📱 iOS App (App Store)
B) 🤖 Android App (Play Store)  
C) 🌐 Web uygulaması/SaaS
D) 🛍️ E-ticaret/Shopify
E) 💼 Fiziksel ürün/hizmet
F) 🔄 Multi-platform (hem iOS hem Android)
...
**Trafik/Kullanıcı durumun:**
A) 🆕 Yeni başlıyorum, hiç kullanıcım yok
B) 🌱 10-100 arası kullanıcım var
C) 📈 100-1000 arası kullanıcım var
D) 🚀 1000+ kullanıcım var, büyümek istiyorum

**Marketing durumun:**
A) ❌ Hiç marketing yapmadım
B) 🔧 Biraz denedim ama düzenli değil
C) ✅ Aktif marketing yapıyorum ama otomasyon istiyorum

İki soruyu birlikte cevaplayabilirsin. 📝
```
...
**Hızlı seçenekler:** (Birini seç ve detaylandır)
...
E) 🏢 İşletmeler/B2B
F) 🤔 Emin değilim, seninle belirlemek istiyorum

Örnek cevap: "B - Yazılım sektöründe çalışan, 25-35 yaş arası developer'lar"
```
...
Rakiplerin kimler? Direkt rakip olmasa bile, kullanıcıların alternatif olarak ne kullanıyor?

**Örnek format:**
- "Duolingo, Anki gibi uygulamalar"
- "Hiçbir app kullanmıyorlar, geleneksel yöntemlerle çözüyorlar"
- "Benzersiz bir ürün, doğrudan rakip yok"

**Bonus:** Rakiplerinin en büyük zayıflığı nedir? (Kullanıcı yorumlarından biliyorsan)
```
...
1. App/ürün adı: ___
2. Platform: ___ (iOS/Android/Web)
