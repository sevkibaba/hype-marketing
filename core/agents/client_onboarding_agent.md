...
**IF NEW PRODUCT:**
Eğer ürün yeni lanse edilecekse (Product Hunt'a uygunsa):

```
🚀 Harika bir fırsatın var! 

Product Hunt, yeni mobil uygulamalar için en etkili ücretsiz lansman platformlarından biri.

**Sana özel bir PH lansman planı hazırlayabilirim:**
- 🗓️ 30 günlük hazırlık takvimi
- 👥 Hunter bulma stratejisi
- 📱 Mobil app'e özel taktikler
- 🎯 Hedef: Top 10 (200-400 upvote)

İstersen PH lansmanını da market planımıza ekleyelim mi?
```
...
**Eğer ürün yeni lanse ediliyorsa:**
- PH (Product Hunt) için uygun olabilir!
- Bunu not alıyorum, PH lansman stratejisi ekleyeceğim
